...
## Langkah Implementasi
Kustomisasi dilakukan dengan memanfaatkan framework CSS yaitu Bootstrap. Terdapat berbagai pre-defined elements yang dapat digunakan melalui framework tersebut. Elemen card dapat diperoleh melalui tautan https://getbootstrap.com/docs/4.0/components/card/. Jika kita ingin membuatnya secara manual, elemen div dengan atribut class="card" dapat didefinisikan terlebih dahulu. Di antara opening dan closing tag div tersebut, kita dapat mendefinisikan elemen-elemen pendukung seperti gambar, text, dan berbagai hal lainnya. Elemen-elemen tersebut dapat dikustomisasikan lebih lanjut dengan memasukkan properti CSS.
